Answer application questions whose answer is a scheme rather than a product: protection
for a feeder, an AMF arrangement, a riser distribution choice. Reason as an electrical
engineer to decide which functions the scheme needs — protection, switching, control,
...
no C&S product. Assume Indian IS/IEC practice unless told otherwise and require final
verification by a licensed engineer.
